        ...
        <div align="center" style="margin-top: 5%">
          ...
          while($row = $result -> fetch_assoc()){
              if($row['emailAluno'] == 'admin@admin.pt'){
                    ...
                    $ida = filter_input(INPUT_POST, "idAluno");
                    $message = "Deseja mesmo eliminar o utilizador e todo o conteudo associado a ele?";
                    echo "<script type='text/javascript'>var r = confirm('$message'); "
                            . "if (r==true){"
                            ."window.location.href='eliminar_utilizador2.php';} else{window.location.href='listar_todos_utilizadores.php';}</script>";  
