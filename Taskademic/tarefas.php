...
<body background="img/task2.jpg">
    ...
    <div align="center" style="margin-top: 5%">
        <a href="criar_tarefa.php"><button><b>Criar Tarefa</b></button></a><br><br>
        <a href="listar_tarefa.php"><button><b>Listar Tarefas</b></button></a><br><br>
        <a href="eliminar_tarefa.php"><button><b>Eliminar Tarefas</b></button></a>
    </div>
</body>
